...
TRAIN_OUT = r"C:\26-1\PT_files\2018train_mi22.pt"
TEST_OUT  = r"C:\26-1\PT_files\2018test_mi22.pt"

FEATURE_TXT = r"C:\26-1\Feature_Text\2018_MI_Top22.txt"
...
# Top-22
# ==========================================
top_idx = np.argsort(mi_scores)[::-1][:TOP_K].copy()
